...
{
    public Meteor meteor1; //Enemy é o script do inimigo enemy é o nome da variavel usada no script atual
    public Meteor meteor2;
    private Meteor prefabMeteor; //criar uma variavel de inimigo para ser instanciado
    ...
    public void Spawn()
        {
            ...
            //instancia o inimigo
            Instantiate(this.prefabMeteor, meteorPosition, Quaternion.identity);
            }
}
